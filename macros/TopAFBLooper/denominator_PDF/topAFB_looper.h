...
public:
    ...
    void fillHistos(TH1D *h1[4][41], float value, double weight, int myType, int PDFset, int Nsolns = 1);
    void fillHistos(TH2D *h2[4][41], float xvalue, float yvalue, double weight, int myType, int PDFset, int Nsolns = 1);
    void fillHistos(TProfile *h2[4][41], float xvalue, float yvalue,  int myType, int PDFset);
...
private:
    ...
    */
    ...
    TH1D *hnJet[4][41];                   // Njet distributions
    TH1D *hnBtagJet[4][41];                   // NBTagjet distributions
    TH1D *hnVtx[4][41];
    TH1D *hAMWTweightnojetsmear[4][41];
    //Top Mass Plots
    TH1D *httRapidity[4][41];
    TH1D *httRapidity2[4][41];
    TH1D *httpT[4][41];
    TH1D *httMass[4][41];
    TH1D *httMass_pull[4][41];
    TH1D *httMass_diff[4][41];
    TH1D *htopMass_diff_plus[4][41];
    TH1D *htopMass_diff_minus[4][41];
    TH1D *htopPCM_diff_plus[4][41];
    TH1D *htopPCM_diff_minus[4][41];

    TH1D *htopMass[4][41];
    TH1D *httpT_gen[4][41];
    TH1D *httMass_gen[4][41];
    TH1D *htopMass_plus_gen[4][41];
    TH1D *htopMass_minus_gen[4][41];
    TH1D *hmassllb[4][41];
    TH1D *hmassltb[4][41];
    TH1D *hmassllb1Dmasscut[4][41];
    TH1D *hmassltb1Dmasscut[4][41];
    TH1D *htheSumJetPt[4][41];
    TH1D *htheSumBtagJetPt[4][41];
    TH1D *hthefirstJetPt[4][41];
    TH1D *hthesecondJetPt[4][41];
    TH1D *htheleadinglepPt[4][41];
    TH1D *hthesecondlepPt[4][41];
    TH1D *hthesumlepPt[4][41];
    TH1D *hlepEta[4][41];
    TH1D *hjetPt[4][41];
    TH1D *hjetEta[4][41];
    TH1D *hMET[4][41];
    TH1D *hdMET[4][41];
    TH1D *htheSumLepPt[4][41];
    TH1D *htopCosTheta[4][41];
    TH1D *hpseudorapiditydiff[4][41];
    TH1D *hrapiditydiff[4][41];
    TH1D *hlepCosTheta[4][41];
    TH1D *hlepChargeAsym[4][41];
    TH1D *hlepAzimAsym[4][41];
    TH1D *hlepAzimAsym2[4][41];
    TH1D *htopSpinCorr[4][41];
    TH1D *hlepCosOpeningAngle[4][41];
    TH1D *htopCosTheta_gen[4][41];
    TH1D *hlepCosTheta_gen[4][41];
    TH1D *hlepChargeAsym_gen[4][41];
    TH1D *hlepAzimAsym_gen[4][41];
    TH1D *hlepAzimAsym2_gen[4][41];
    TH1D *htopSpinCorr_gen[4][41];
    TH1D *hlepCosOpeningAngle_gen[4][41];

    TH1D *hlepRapDiff[4][41];
    TH1D *hlepAngleBetween[4][41];
    TH1D *hlepAngleBetweenCMS[4][41];
    TH1D *hpseudorapiditydiff2[4][41];
    TH1D *hrapiditydiff2[4][41];
    TH1D *hlepPlusCosTheta[4][41];
    TH1D *hlepMinusCosTheta[4][41];
    TH1D *hjetAzimAsym[4][41];
    TH1D *hjetRapDiff[4][41];
    TH1D *hjetAngleBetween[4][41];
    TH1D *hjetAngleBetweenCMS[4][41];
    TH1D *hlepPhi[4][41];
    TH1D *hlepPlusPhi[4][41];
    TH1D *hlepMinusPhi[4][41];
    TH1D *hjetPhi[4][41];
    TH1D *hlepPlusEta[4][41];
    TH1D *hlepMinusEta[4][41];
    TH1D *hlepPlusPt[4][41];
    TH1D *hlepMinusPt[4][41];

    TH1D *hlepPt[4][41];
    TH1D *hrapiditydiffMarco[4][41];

    TH1D *hlepPlusCosTheta_gen[4][41];
    TH1D *hlepMinusCosTheta_gen[4][41];
    TH1D *hpseudorapiditydiff_gen[4][41];
    TH1D *hrapiditydiff_gen[4][41];
    TH1D *hrapiditydiffMarco_gen[4][41];

    TH2D *hlepChargeAsym_gen2d[4][41];
    TH2D *hlepAzimAsym_gen2d[4][41];
    TH2D *hlepAzimAsym2_gen2d[4][41];
    TH2D *htopSpinCorr_gen2d[4][41];
    TH2D *hlepCosOpeningAngle_gen2d[4][41];
    TH2D *htopCosTheta_gen2d[4][41];
    TH2D *hlepCosTheta_gen2d[4][41];
    TH2D *hlepPlusCosTheta_gen2d[4][41];
    TH2D *hlepMinusCosTheta_gen2d[4][41];
    TH2D *hpseudorapiditydiff_gen2d[4][41];
    TH2D *hrapiditydiff_gen2d[4][41];
    TH2D *hrapiditydiffMarco_gen2d[4][41];

    TH2D *hlepChargeAsym_ttpT_gen2d[4][41];
    TH2D *hlepAzimAsym_ttpT_gen2d[4][41];
    TH2D *hlepAzimAsym2_ttpT_gen2d[4][41];
    TH2D *htopSpinCorr_ttpT_gen2d[4][41];
    TH2D *hlepCosOpeningAngle_ttpT_gen2d[4][41];
    TH2D *htopCosTheta_ttpT_gen2d[4][41];
    TH2D *hlepCosTheta_ttpT_gen2d[4][41];
    TH2D *hlepPlusCosTheta_ttpT_gen2d[4][41];
    TH2D *hlepMinusCosTheta_ttpT_gen2d[4][41];
    TH2D *hpseudorapiditydiff_ttpT_gen2d[4][41];
    TH2D *hrapiditydiff_ttpT_gen2d[4][41];
    TH2D *hrapiditydiffMarco_ttpT_gen2d[4][41];


    TH2D *hlepChargeAsym_ttRapidity2_gen2d[4][41];
    TH2D *hlepAzimAsym_ttRapidity2_gen2d[4][41];
    TH2D *hlepAzimAsym2_ttRapidity2_gen2d[4][41];
    TH2D *htopSpinCorr_ttRapidity2_gen2d[4][41];
    TH2D *hlepCosOpeningAngle_ttRapidity2_gen2d[4][41];
    TH2D *htopCosTheta_ttRapidity2_gen2d[4][41];
    TH2D *hlepCosTheta_ttRapidity2_gen2d[4][41];
    TH2D *hlepPlusCosTheta_ttRapidity2_gen2d[4][41];
    TH2D *hlepMinusCosTheta_ttRapidity2_gen2d[4][41];
    TH2D *hpseudorapiditydiff_ttRapidity2_gen2d[4][41];
    TH2D *hrapiditydiff_ttRapidity2_gen2d[4][41];
    TH2D *hrapiditydiffMarco_ttRapidity2_gen2d[4][41];


    TH1D *hlepChargeAsymGenDiff[4][41];
    TH1D *hlepAzimAsymGenDiff[4][41];
    TH1D *hlepAzimAsym2GenDiff[4][41];
    TH1D *htopSpinCorrGenDiff[4][41];
    TH1D *hlepCosOpeningAngleGenDiff[4][41];
    TH1D *htopCosThetaGenDiff[4][41];
    TH1D *hlepCosThetaGenDiff[4][41];
    TH1D *hlepPlusCosThetaGenDiff[4][41];
    TH1D *hlepMinusCosThetaGenDiff[4][41];
    TH1D *hpseudorapiditydiffGenDiff[4][41];
    TH1D *hrapiditydiffGenDiff[4][41];
    TH1D *hrapiditydiffMarcoGenDiff[4][41];


    TH2D *htopCosTheta_2d[4][41];
    TH2D *hlepCosTheta_2d[4][41];
    TH2D *hlepChargeAsym_2d[4][41];
    TH2D *hlepAzimAsym_2d[4][41];
    TH2D *htopSpinCorr_2d[4][41];
    TH2D *hlepCosOpeningAngle_2d[4][41];
    TH2D *httMass_2d[4][41];
    TH2D *httpT_2d[4][41];
    TH2D *htopP_2d[4][41];

    TH2D *hmasslb_2d[4][41];


    TH1D *httMassGluongenp[4][41];
    TH1D *httMassQuarkgenp[4][41];
    TH1D *httRapidityGluongenp[4][41];
    TH1D *httRapidityQuarkgenp[4][41];


    TH1D *hlepPlusCosThetaTau_gen[4][41];
    TH1D *hlepMinusCosThetaTau_gen[4][41];

    TH1D *hlepPlusxTau_gen[4][41];
    TH1D *hlepMinusxTau_gen[4][41];

    // For the DY Estimation
    TH1D *hmetInDYEst[4][41];         // MET in Z window for the DY Estimation
    TH1D *hmetOutDYEst[4][41];        // MET outside Z window for the DY Estimation
    TH1D *hdilMassWithMetDYEst[4][41];// Dilepton mass with MET requirement for DY estimation
    TH1D *hdilMassNoMetDYEst[4][41];  // Dilepton mass without MET requirement for DY estimation
