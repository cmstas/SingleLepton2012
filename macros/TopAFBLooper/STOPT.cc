...
namespace Stop {
	...
	float &m_topplus_gen() { return stopt.m_topplus_gen(); }
	float &tt_mass_gen() { return stopt.tt_mass_gen(); }
	float &ttRapidity_gen() { return stopt.ttRapidity_gen(); }
	float &ttRapidity2_gen() { return stopt.ttRapidity2_gen(); }
	float &top_rapiditydiff_cms_gen() { return stopt.top_rapiditydiff_cms_gen(); }
	float &top_pseudorapiditydiff_cms_gen() { return stopt.top_pseudorapiditydiff_cms_gen(); }
	float &top_rapiditydiff_Marco_gen() { return stopt.top_rapiditydiff_Marco_gen(); }
	float &tt_pT_gen() { return stopt.tt_pT_gen(); }
	float &top_costheta_cms_gen() { return stopt.top_costheta_cms_gen(); }
	float &lep_charge_asymmetry_gen() { return stopt.lep_charge_asymmetry_gen(); }
	float &lep_azimuthal_asymmetry_gen() { return stopt.lep_azimuthal_asymmetry_gen(); }
	float &lep_azimuthal_asymmetry2_gen() { return stopt.lep_azimuthal_asymmetry2_gen(); }
	float &lepPlus_costheta_cms_gen() { return stopt.lepPlus_costheta_cms_gen(); }
	...
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepPlus_status3() { return stopt.lepPlus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepMinus_status3() { return stopt.lepMinus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bPlus_status3() { return stopt.bPlus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bMinus_status3() { return stopt.bMinus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuPlus_status3() { return stopt.nuPlus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status3() { return stopt.nuMinus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topPlus_status3() { return stopt.topPlus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topMinus_status3() { return stopt.topMinus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WPlus_status3() { return stopt.WPlus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WMinus_status3() { return stopt.WMinus_status3(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepPlus_status1() { return stopt.lepPlus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepMinus_status1() { return stopt.lepMinus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bPlus_status1() { return stopt.bPlus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bMinus_status1() { return stopt.bMinus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuPlus_status1() { return stopt.nuPlus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status1() { return stopt.nuMinus_status1(); }
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topPlus_status1() { return stopt.topPlus_status1(); }
	...
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status3_orig() { return stopt.nuMinus_status3_orig(); }
