...
protected: 
	...
	int lepMinus_status3_nDaughters_;
	TBranch *lepMinus_status3_nDaughters_branch;
	bool lepMinus_status3_nDaughters_isLoaded;
	...
	float m_topminus_gen_;
	TBranch *m_topminus_gen_branch;
	bool m_topminus_gen_isLoaded;
	float m_topplus_gen_;
	TBranch *m_topplus_gen_branch;
	bool m_topplus_gen_isLoaded;
	float tt_mass_gen_;
	TBranch *tt_mass_gen_branch;
	bool tt_mass_gen_isLoaded;
	float ttRapidity_gen_;
	TBranch *ttRapidity_gen_branch;
	bool ttRapidity_gen_isLoaded;
	float ttRapidity2_gen_;
	TBranch *ttRapidity2_gen_branch;
	bool ttRapidity2_gen_isLoaded;
	float top_rapiditydiff_cms_gen_;
	TBranch *top_rapiditydiff_cms_gen_branch;
	bool top_rapiditydiff_cms_gen_isLoaded;
	float top_pseudorapiditydiff_cms_gen_;
	TBranch *top_pseudorapiditydiff_cms_gen_branch;
	bool top_pseudorapiditydiff_cms_gen_isLoaded;
	float top_rapiditydiff_Marco_gen_;
	TBranch *top_rapiditydiff_Marco_gen_branch;
	bool top_rapiditydiff_Marco_gen_isLoaded;
	float tt_pT_gen_;
	TBranch *tt_pT_gen_branch;
	bool tt_pT_gen_isLoaded;
	float top_costheta_cms_gen_;
	TBranch *top_costheta_cms_gen_branch;
	bool top_costheta_cms_gen_isLoaded;
	float lep_charge_asymmetry_gen_;
	TBranch *lep_charge_asymmetry_gen_branch;
	bool lep_charge_asymmetry_gen_isLoaded;
	float lep_azimuthal_asymmetry_gen_;
	TBranch *lep_azimuthal_asymmetry_gen_branch;
	bool lep_azimuthal_asymmetry_gen_isLoaded;
	float lep_azimuthal_asymmetry2_gen_;
	TBranch *lep_azimuthal_asymmetry2_gen_branch;
	bool lep_azimuthal_asymmetry2_gen_isLoaded;
	float lepPlus_costheta_cms_gen_;
	TBranch *lepPlus_costheta_cms_gen_branch;
	bool lepPlus_costheta_cms_gen_isLoaded;
	float lepMinus_costheta_cms_gen_;
	TBranch *lepMinus_costheta_cms_gen_branch;
	bool lepMinus_costheta_cms_gen_isLoaded;
	float top_spin_correlation_gen_;
	TBranch *top_spin_correlation_gen_branch;
	bool top_spin_correlation_gen_isLoaded;
	...
	TBranch *b_branch;
	bool b_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *bbar_;
	TBranch *bbar_branch;
	bool bbar_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *lepPlus_status3_;
	TBranch *lepPlus_status3_branch;
	bool lepPlus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *lepMinus_status3_;
	TBranch *lepMinus_status3_branch;
	bool lepMinus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *bPlus_status3_;
	TBranch *bPlus_status3_branch;
	bool bPlus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *bMinus_status3_;
	TBranch *bMinus_status3_branch;
	bool bMinus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuPlus_status3_;
	TBranch *nuPlus_status3_branch;
	bool nuPlus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuMinus_status3_;
	TBranch *nuMinus_status3_branch;
	bool nuMinus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *topPlus_status3_;
	TBranch *topPlus_status3_branch;
	bool topPlus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *topMinus_status3_;
	TBranch *topMinus_status3_branch;
	bool topMinus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *WPlus_status3_;
	TBranch *WPlus_status3_branch;
	bool WPlus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *WMinus_status3_;
	TBranch *WMinus_status3_branch;
	bool WMinus_status3_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *lepPlus_status1_;
	TBranch *lepPlus_status1_branch;
	bool lepPlus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *lepMinus_status1_;
	TBranch *lepMinus_status1_branch;
	bool lepMinus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *bPlus_status1_;
	TBranch *bPlus_status1_branch;
	bool bPlus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *bMinus_status1_;
	TBranch *bMinus_status1_branch;
	bool bMinus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuPlus_status1_;
	TBranch *nuPlus_status1_branch;
	bool nuPlus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuMinus_status1_;
	TBranch *nuMinus_status1_branch;
	bool nuMinus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *topPlus_status1_;
	TBranch *topPlus_status1_branch;
	bool topPlus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *topMinus_status1_;
	TBranch *topMinus_status1_branch;
	bool topMinus_status1_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *WPlus_status3_orig_;
	TBranch *WPlus_status3_orig_branch;
	bool WPlus_status3_orig_isLoaded;
	...
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *lepMinus_status3_orig_;
	TBranch *lepMinus_status3_orig_branch;
	bool lepMinus_status3_orig_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuPlus_status3_orig_;
	TBranch *nuPlus_status3_orig_branch;
	bool nuPlus_status3_orig_isLoaded;
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > *nuMinus_status3_orig_;
	TBranch *nuMinus_status3_orig_branch;
	bool nuMinus_status3_orig_isLoaded;
...
void Init(TTree *tree) {
	lepPlus_status3_id_branch = 0;
	if (tree->GetBranch("lepPlus_status3_id") != 0) {
	...
	if (tree->GetBranch("lepPlus_status3_nDaughters") != 0) {
		lepPlus_status3_nDaughters_branch = tree->GetBranch("lepPlus_status3_nDaughters");
		if (lepPlus_status3_nDaughters_branch) {lepPlus_status3_nDaughters_branch->SetAddress(&lepPlus_status3_nDaughters_);}
	}
	lepMinus_status3_nDaughters_branch = 0;
	if (tree->GetBranch("lepMinus_status3_nDaughters") != 0) {
		lepMinus_status3_nDaughters_branch = tree->GetBranch("lepMinus_status3_nDaughters");
		if (lepMinus_status3_nDaughters_branch) {lepMinus_status3_nDaughters_branch->SetAddress(&lepMinus_status3_nDaughters_);}
	}
	nuPlus_status3_id_branch = 0;
	if (tree->GetBranch("nuPlus_status3_id") != 0) {
	...
	if (tree->GetBranch("rapidityttbar") != 0) {
		rapidityttbar_branch = tree->GetBranch("rapidityttbar");
		if (rapidityttbar_branch) {rapidityttbar_branch->SetAddress(&rapidityttbar_);}
	}
	m_topminus_gen_branch = 0;
	if (tree->GetBranch("m_topminus_gen") != 0) {
		m_topminus_gen_branch = tree->GetBranch("m_topminus_gen");
		if (m_topminus_gen_branch) {m_topminus_gen_branch->SetAddress(&m_topminus_gen_);}
	}
	m_topplus_gen_branch = 0;
	if (tree->GetBranch("m_topplus_gen") != 0) {
		m_topplus_gen_branch = tree->GetBranch("m_topplus_gen");
		if (m_topplus_gen_branch) {m_topplus_gen_branch->SetAddress(&m_topplus_gen_);}
	}
	tt_mass_gen_branch = 0;
	if (tree->GetBranch("tt_mass_gen") != 0) {
		tt_mass_gen_branch = tree->GetBranch("tt_mass_gen");
		if (tt_mass_gen_branch) {tt_mass_gen_branch->SetAddress(&tt_mass_gen_);}
	}
	ttRapidity_gen_branch = 0;
	if (tree->GetBranch("ttRapidity_gen") != 0) {
		ttRapidity_gen_branch = tree->GetBranch("ttRapidity_gen");
		if (ttRapidity_gen_branch) {ttRapidity_gen_branch->SetAddress(&ttRapidity_gen_);}
	}
	ttRapidity2_gen_branch = 0;
	if (tree->GetBranch("ttRapidity2_gen") != 0) {
		ttRapidity2_gen_branch = tree->GetBranch("ttRapidity2_gen");
		if (ttRapidity2_gen_branch) {ttRapidity2_gen_branch->SetAddress(&ttRapidity2_gen_);}
	}
	top_rapiditydiff_cms_gen_branch = 0;
	if (tree->GetBranch("top_rapiditydiff_cms_gen") != 0) {
		top_rapiditydiff_cms_gen_branch = tree->GetBranch("top_rapiditydiff_cms_gen");
		if (top_rapiditydiff_cms_gen_branch) {top_rapiditydiff_cms_gen_branch->SetAddress(&top_rapiditydiff_cms_gen_);}
	}
	top_pseudorapiditydiff_cms_gen_branch = 0;
	if (tree->GetBranch("top_pseudorapiditydiff_cms_gen") != 0) {
		top_pseudorapiditydiff_cms_gen_branch = tree->GetBranch("top_pseudorapiditydiff_cms_gen");
		if (top_pseudorapiditydiff_cms_gen_branch) {top_pseudorapiditydiff_cms_gen_branch->SetAddress(&top_pseudorapiditydiff_cms_gen_);}
	}
	top_rapiditydiff_Marco_gen_branch = 0;
	if (tree->GetBranch("top_rapiditydiff_Marco_gen") != 0) {
		top_rapiditydiff_Marco_gen_branch = tree->GetBranch("top_rapiditydiff_Marco_gen");
		if (top_rapiditydiff_Marco_gen_branch) {top_rapiditydiff_Marco_gen_branch->SetAddress(&top_rapiditydiff_Marco_gen_);}
	}
	tt_pT_gen_branch = 0;
	if (tree->GetBranch("tt_pT_gen") != 0) {
		tt_pT_gen_branch = tree->GetBranch("tt_pT_gen");
		if (tt_pT_gen_branch) {tt_pT_gen_branch->SetAddress(&tt_pT_gen_);}
	}
	top_costheta_cms_gen_branch = 0;
	if (tree->GetBranch("top_costheta_cms_gen") != 0) {
		top_costheta_cms_gen_branch = tree->GetBranch("top_costheta_cms_gen");
		if (top_costheta_cms_gen_branch) {top_costheta_cms_gen_branch->SetAddress(&top_costheta_cms_gen_);}
	}
	lep_charge_asymmetry_gen_branch = 0;
	if (tree->GetBranch("lep_charge_asymmetry_gen") != 0) {
		lep_charge_asymmetry_gen_branch = tree->GetBranch("lep_charge_asymmetry_gen");
		if (lep_charge_asymmetry_gen_branch) {lep_charge_asymmetry_gen_branch->SetAddress(&lep_charge_asymmetry_gen_);}
	}
	lep_azimuthal_asymmetry_gen_branch = 0;
	if (tree->GetBranch("lep_azimuthal_asymmetry_gen") != 0) {
		lep_azimuthal_asymmetry_gen_branch = tree->GetBranch("lep_azimuthal_asymmetry_gen");
		if (lep_azimuthal_asymmetry_gen_branch) {lep_azimuthal_asymmetry_gen_branch->SetAddress(&lep_azimuthal_asymmetry_gen_);}
	}
	lep_azimuthal_asymmetry2_gen_branch = 0;
	if (tree->GetBranch("lep_azimuthal_asymmetry2_gen") != 0) {
		lep_azimuthal_asymmetry2_gen_branch = tree->GetBranch("lep_azimuthal_asymmetry2_gen");
		if (lep_azimuthal_asymmetry2_gen_branch) {lep_azimuthal_asymmetry2_gen_branch->SetAddress(&lep_azimuthal_asymmetry2_gen_);}
	}
	lepPlus_costheta_cms_gen_branch = 0;
	if (tree->GetBranch("lepPlus_costheta_cms_gen") != 0) {
		lepPlus_costheta_cms_gen_branch = tree->GetBranch("lepPlus_costheta_cms_gen");
		if (lepPlus_costheta_cms_gen_branch) {lepPlus_costheta_cms_gen_branch->SetAddress(&lepPlus_costheta_cms_gen_);}
	}
	lepMinus_costheta_cms_gen_branch = 0;
	if (tree->GetBranch("lepMinus_costheta_cms_gen") != 0) {
		lepMinus_costheta_cms_gen_branch = tree->GetBranch("lepMinus_costheta_cms_gen");
		if (lepMinus_costheta_cms_gen_branch) {lepMinus_costheta_cms_gen_branch->SetAddress(&lepMinus_costheta_cms_gen_);}
	}
	top_spin_correlation_gen_branch = 0;
	if (tree->GetBranch("top_spin_correlation_gen") != 0) {
		top_spin_correlation_gen_branch = tree->GetBranch("top_spin_correlation_gen");
		if (top_spin_correlation_gen_branch) {top_spin_correlation_gen_branch->SetAddress(&top_spin_correlation_gen_);}
	}
	lep_cos_opening_angle_gen_branch = 0;
	if (tree->GetBranch("lep_cos_opening_angle_gen") != 0) {
	...
	if (tree->GetBranch("b") != 0) {
		b_branch = tree->GetBranch("b");
		if (b_branch) {b_branch->SetAddress(&b_);}
	}
	bbar_branch = 0;
	if (tree->GetBranch("bbar") != 0) {
		bbar_branch = tree->GetBranch("bbar");
		if (bbar_branch) {bbar_branch->SetAddress(&bbar_);}
	}
	lepPlus_status3_branch = 0;
	if (tree->GetBranch("lepPlus_status3") != 0) {
		lepPlus_status3_branch = tree->GetBranch("lepPlus_status3");
		if (lepPlus_status3_branch) {lepPlus_status3_branch->SetAddress(&lepPlus_status3_);}
	}
	lepMinus_status3_branch = 0;
	if (tree->GetBranch("lepMinus_status3") != 0) {
		lepMinus_status3_branch = tree->GetBranch("lepMinus_status3");
		if (lepMinus_status3_branch) {lepMinus_status3_branch->SetAddress(&lepMinus_status3_);}
	}
	bPlus_status3_branch = 0;
	if (tree->GetBranch("bPlus_status3") != 0) {
		bPlus_status3_branch = tree->GetBranch("bPlus_status3");
		if (bPlus_status3_branch) {bPlus_status3_branch->SetAddress(&bPlus_status3_);}
	}
	bMinus_status3_branch = 0;
	if (tree->GetBranch("bMinus_status3") != 0) {
		bMinus_status3_branch = tree->GetBranch("bMinus_status3");
		if (bMinus_status3_branch) {bMinus_status3_branch->SetAddress(&bMinus_status3_);}
	}
	nuPlus_status3_branch = 0;
	if (tree->GetBranch("nuPlus_status3") != 0) {
		nuPlus_status3_branch = tree->GetBranch("nuPlus_status3");
		if (nuPlus_status3_branch) {nuPlus_status3_branch->SetAddress(&nuPlus_status3_);}
	}
	nuMinus_status3_branch = 0;
	if (tree->GetBranch("nuMinus_status3") != 0) {
		nuMinus_status3_branch = tree->GetBranch("nuMinus_status3");
		if (nuMinus_status3_branch) {nuMinus_status3_branch->SetAddress(&nuMinus_status3_);}
	}
	topPlus_status3_branch = 0;
	if (tree->GetBranch("topPlus_status3") != 0) {
		topPlus_status3_branch = tree->GetBranch("topPlus_status3");
		if (topPlus_status3_branch) {topPlus_status3_branch->SetAddress(&topPlus_status3_);}
	}
	topMinus_status3_branch = 0;
	if (tree->GetBranch("topMinus_status3") != 0) {
		topMinus_status3_branch = tree->GetBranch("topMinus_status3");
		if (topMinus_status3_branch) {topMinus_status3_branch->SetAddress(&topMinus_status3_);}
	}
	WPlus_status3_branch = 0;
	if (tree->GetBranch("WPlus_status3") != 0) {
		WPlus_status3_branch = tree->GetBranch("WPlus_status3");
		if (WPlus_status3_branch) {WPlus_status3_branch->SetAddress(&WPlus_status3_);}
	}
	WMinus_status3_branch = 0;
	if (tree->GetBranch("WMinus_status3") != 0) {
		WMinus_status3_branch = tree->GetBranch("WMinus_status3");
		if (WMinus_status3_branch) {WMinus_status3_branch->SetAddress(&WMinus_status3_);}
	}
	lepPlus_status1_branch = 0;
	if (tree->GetBranch("lepPlus_status1") != 0) {
		lepPlus_status1_branch = tree->GetBranch("lepPlus_status1");
		if (lepPlus_status1_branch) {lepPlus_status1_branch->SetAddress(&lepPlus_status1_);}
	}
	lepMinus_status1_branch = 0;
	if (tree->GetBranch("lepMinus_status1") != 0) {
		lepMinus_status1_branch = tree->GetBranch("lepMinus_status1");
		if (lepMinus_status1_branch) {lepMinus_status1_branch->SetAddress(&lepMinus_status1_);}
	}
	bPlus_status1_branch = 0;
	if (tree->GetBranch("bPlus_status1") != 0) {
		bPlus_status1_branch = tree->GetBranch("bPlus_status1");
		if (bPlus_status1_branch) {bPlus_status1_branch->SetAddress(&bPlus_status1_);}
	}
	bMinus_status1_branch = 0;
	if (tree->GetBranch("bMinus_status1") != 0) {
		bMinus_status1_branch = tree->GetBranch("bMinus_status1");
		if (bMinus_status1_branch) {bMinus_status1_branch->SetAddress(&bMinus_status1_);}
	}
	nuPlus_status1_branch = 0;
	if (tree->GetBranch("nuPlus_status1") != 0) {
		nuPlus_status1_branch = tree->GetBranch("nuPlus_status1");
		if (nuPlus_status1_branch) {nuPlus_status1_branch->SetAddress(&nuPlus_status1_);}
	}
	nuMinus_status1_branch = 0;
	if (tree->GetBranch("nuMinus_status1") != 0) {
		nuMinus_status1_branch = tree->GetBranch("nuMinus_status1");
		if (nuMinus_status1_branch) {nuMinus_status1_branch->SetAddress(&nuMinus_status1_);}
	}
	topPlus_status1_branch = 0;
	if (tree->GetBranch("topPlus_status1") != 0) {
		topPlus_status1_branch = tree->GetBranch("topPlus_status1");
		if (topPlus_status1_branch) {topPlus_status1_branch->SetAddress(&topPlus_status1_);}
	}
	topMinus_status1_branch = 0;
	if (tree->GetBranch("topMinus_status1") != 0) {
		topMinus_status1_branch = tree->GetBranch("topMinus_status1");
		if (topMinus_status1_branch) {topMinus_status1_branch->SetAddress(&topMinus_status1_);}
	}
	WPlus_status3_orig_branch = 0;
	if (tree->GetBranch("WPlus_status3_orig") != 0) {
		WPlus_status3_orig_branch = tree->GetBranch("WPlus_status3_orig");
		if (WPlus_status3_orig_branch) {WPlus_status3_orig_branch->SetAddress(&WPlus_status3_orig_);}
	}
	WMinus_status3_orig_branch = 0;
	if (tree->GetBranch("WMinus_status3_orig") != 0) {
	...
	if (tree->GetBranch("lepPlus_status3_orig") != 0) {
		lepPlus_status3_orig_branch = tree->GetBranch("lepPlus_status3_orig");
		if (lepPlus_status3_orig_branch) {lepPlus_status3_orig_branch->SetAddress(&lepPlus_status3_orig_);}
	}
	lepMinus_status3_orig_branch = 0;
	if (tree->GetBranch("lepMinus_status3_orig") != 0) {
		lepMinus_status3_orig_branch = tree->GetBranch("lepMinus_status3_orig");
		if (lepMinus_status3_orig_branch) {lepMinus_status3_orig_branch->SetAddress(&lepMinus_status3_orig_);}
	}
	nuPlus_status3_orig_branch = 0;
	if (tree->GetBranch("nuPlus_status3_orig") != 0) {
		nuPlus_status3_orig_branch = tree->GetBranch("nuPlus_status3_orig");
		if (nuPlus_status3_orig_branch) {nuPlus_status3_orig_branch->SetAddress(&nuPlus_status3_orig_);}
	}
	nuMinus_status3_orig_branch = 0;
	if (tree->GetBranch("nuMinus_status3_orig") != 0) {
		nuMinus_status3_orig_branch = tree->GetBranch("nuMinus_status3_orig");
		if (nuMinus_status3_orig_branch) {nuMinus_status3_orig_branch->SetAddress(&nuMinus_status3_orig_);}
	}
...
void GetEntry(unsigned int idx) 
	// this only marks branches as not loaded, saving a lot of time
	{
		...
		tt_mass_gen_isLoaded = false;
		ttRapidity_gen_isLoaded = false;
		ttRapidity2_gen_isLoaded = false;
		top_rapiditydiff_cms_gen_isLoaded = false;
		top_pseudorapiditydiff_cms_gen_isLoaded = false;
		top_rapiditydiff_Marco_gen_isLoaded = false;
		tt_pT_gen_isLoaded = false;
		top_costheta_cms_gen_isLoaded = false;
		lep_charge_asymmetry_gen_isLoaded = false;
		lep_azimuthal_asymmetry_gen_isLoaded = false;
		lep_azimuthal_asymmetry2_gen_isLoaded = false;
		lepPlus_costheta_cms_gen_isLoaded = false;
		...
		lepMinus_status3_isLoaded = false;
		bPlus_status3_isLoaded = false;
		bMinus_status3_isLoaded = false;
		nuPlus_status3_isLoaded = false;
		nuMinus_status3_isLoaded = false;
		topPlus_status3_isLoaded = false;
		topMinus_status3_isLoaded = false;
		WPlus_status3_isLoaded = false;
		WMinus_status3_isLoaded = false;
		lepPlus_status1_isLoaded = false;
		lepMinus_status1_isLoaded = false;
		bPlus_status1_isLoaded = false;
		bMinus_status1_isLoaded = false;
		nuPlus_status1_isLoaded = false;
		nuMinus_status1_isLoaded = false;
		topPlus_status1_isLoaded = false;
		...
		nuMinus_status3_orig_isLoaded = false;
	...
	// load all branches
{
	...
	if (tt_mass_gen_branch != 0) tt_mass_gen();
	if (ttRapidity_gen_branch != 0) ttRapidity_gen();
	if (ttRapidity2_gen_branch != 0) ttRapidity2_gen();
	if (top_rapiditydiff_cms_gen_branch != 0) top_rapiditydiff_cms_gen();
	if (top_pseudorapiditydiff_cms_gen_branch != 0) top_pseudorapiditydiff_cms_gen();
	if (top_rapiditydiff_Marco_gen_branch != 0) top_rapiditydiff_Marco_gen();
	if (tt_pT_gen_branch != 0) tt_pT_gen();
	if (top_costheta_cms_gen_branch != 0) top_costheta_cms_gen();
	if (lep_charge_asymmetry_gen_branch != 0) lep_charge_asymmetry_gen();
	if (lep_azimuthal_asymmetry_gen_branch != 0) lep_azimuthal_asymmetry_gen();
	if (lep_azimuthal_asymmetry2_gen_branch != 0) lep_azimuthal_asymmetry2_gen();
	if (lepPlus_costheta_cms_gen_branch != 0) lepPlus_costheta_cms_gen();
	...
	if (lepMinus_status3_branch != 0) lepMinus_status3();
	if (bPlus_status3_branch != 0) bPlus_status3();
	if (bMinus_status3_branch != 0) bMinus_status3();
	if (nuPlus_status3_branch != 0) nuPlus_status3();
	if (nuMinus_status3_branch != 0) nuMinus_status3();
	if (topPlus_status3_branch != 0) topPlus_status3();
	if (topMinus_status3_branch != 0) topMinus_status3();
	if (WPlus_status3_branch != 0) WPlus_status3();
	if (WMinus_status3_branch != 0) WMinus_status3();
	if (lepPlus_status1_branch != 0) lepPlus_status1();
	if (lepMinus_status1_branch != 0) lepMinus_status1();
	if (bPlus_status1_branch != 0) bPlus_status1();
	if (bMinus_status1_branch != 0) bMinus_status1();
	if (nuPlus_status1_branch != 0) nuPlus_status1();
	if (nuMinus_status1_branch != 0) nuMinus_status1();
	if (topPlus_status1_branch != 0) topPlus_status1();
	...
	if (nuMinus_status3_orig_branch != 0) nuMinus_status3_orig();
	...
	{
		if (not lepPlus_status3_id_isLoaded) {
			if (lepPlus_status3_id_branch != 0) {
				lepPlus_status3_id_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_status3_id_branch does not exist!\n");
				exit(1);
			}
			lepPlus_status3_id_isLoaded = true;
		}
	...
	int &lepMinus_status3_id()
	{
		if (not lepMinus_status3_id_isLoaded) {
			if (lepMinus_status3_id_branch != 0) {
				lepMinus_status3_id_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_status3_id_branch does not exist!\n");
				exit(1);
			}
	...
	{
		if (not lepPlus_status3_nDaughters_isLoaded) {
			if (lepPlus_status3_nDaughters_branch != 0) {
				lepPlus_status3_nDaughters_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_status3_nDaughters_branch does not exist!\n");
				exit(1);
			}
			lepPlus_status3_nDaughters_isLoaded = true;
		}
		return lepPlus_status3_nDaughters_;
	}
	int &lepMinus_status3_nDaughters()
	{
		if (not lepMinus_status3_nDaughters_isLoaded) {
			if (lepMinus_status3_nDaughters_branch != 0) {
				lepMinus_status3_nDaughters_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_status3_nDaughters_branch does not exist!\n");
				exit(1);
			}
			lepMinus_status3_nDaughters_isLoaded = true;
		}
		return lepMinus_status3_nDaughters_;
	}
	int &nuPlus_status3_id()
	{
		if (not nuPlus_status3_id_isLoaded) {
			if (nuPlus_status3_id_branch != 0) {
				nuPlus_status3_id_branch->GetEntry(index);
			} else {
				printf("branch nuPlus_status3_id_branch does not exist!\n");
				exit(1);
			}
			nuPlus_status3_id_isLoaded = true;
		}
	...
	int &nuMinus_status3_id()
	{
		if (not nuMinus_status3_id_isLoaded) {
			if (nuMinus_status3_id_branch != 0) {
				nuMinus_status3_id_branch->GetEntry(index);
			} else {
				printf("branch nuMinus_status3_id_branch does not exist!\n");
				exit(1);
			}
	...
	float &rapidityttbar()
	{
		if (not rapidityttbar_isLoaded) {
			if (rapidityttbar_branch != 0) {
				rapidityttbar_branch->GetEntry(index);
			} else {
				printf("branch rapidityttbar_branch does not exist!\n");
				exit(1);
			}
			rapidityttbar_isLoaded = true;
		}
		return rapidityttbar_;
	}
	float &m_topminus_gen()
	{
		if (not m_topminus_gen_isLoaded) {
			if (m_topminus_gen_branch != 0) {
				m_topminus_gen_branch->GetEntry(index);
			} else {
				printf("branch m_topminus_gen_branch does not exist!\n");
				exit(1);
			}
			m_topminus_gen_isLoaded = true;
		}
		return m_topminus_gen_;
	}
	float &m_topplus_gen()
	{
		if (not m_topplus_gen_isLoaded) {
			if (m_topplus_gen_branch != 0) {
				m_topplus_gen_branch->GetEntry(index);
			} else {
				printf("branch m_topplus_gen_branch does not exist!\n");
				exit(1);
			}
			m_topplus_gen_isLoaded = true;
		}
		return m_topplus_gen_;
	}
	float &tt_mass_gen()
	{
		if (not tt_mass_gen_isLoaded) {
			if (tt_mass_gen_branch != 0) {
				tt_mass_gen_branch->GetEntry(index);
			} else {
				printf("branch tt_mass_gen_branch does not exist!\n");
				exit(1);
			}
			tt_mass_gen_isLoaded = true;
		}
		return tt_mass_gen_;
	}
	float &ttRapidity_gen()
	{
		if (not ttRapidity_gen_isLoaded) {
			if (ttRapidity_gen_branch != 0) {
				ttRapidity_gen_branch->GetEntry(index);
			} else {
				printf("branch ttRapidity_gen_branch does not exist!\n");
				exit(1);
			}
			ttRapidity_gen_isLoaded = true;
		}
		return ttRapidity_gen_;
	}
	float &ttRapidity2_gen()
	{
		if (not ttRapidity2_gen_isLoaded) {
			if (ttRapidity2_gen_branch != 0) {
				ttRapidity2_gen_branch->GetEntry(index);
			} else {
				printf("branch ttRapidity2_gen_branch does not exist!\n");
				exit(1);
			}
			ttRapidity2_gen_isLoaded = true;
		}
		return ttRapidity2_gen_;
	}
	float &top_rapiditydiff_cms_gen()
	{
		if (not top_rapiditydiff_cms_gen_isLoaded) {
			if (top_rapiditydiff_cms_gen_branch != 0) {
				top_rapiditydiff_cms_gen_branch->GetEntry(index);
			} else {
				printf("branch top_rapiditydiff_cms_gen_branch does not exist!\n");
				exit(1);
			}
			top_rapiditydiff_cms_gen_isLoaded = true;
		}
		return top_rapiditydiff_cms_gen_;
	}
	float &top_pseudorapiditydiff_cms_gen()
	{
		if (not top_pseudorapiditydiff_cms_gen_isLoaded) {
			if (top_pseudorapiditydiff_cms_gen_branch != 0) {
				top_pseudorapiditydiff_cms_gen_branch->GetEntry(index);
			} else {
				printf("branch top_pseudorapiditydiff_cms_gen_branch does not exist!\n");
				exit(1);
			}
			top_pseudorapiditydiff_cms_gen_isLoaded = true;
		}
		return top_pseudorapiditydiff_cms_gen_;
	}
	float &top_rapiditydiff_Marco_gen()
	{
		if (not top_rapiditydiff_Marco_gen_isLoaded) {
			if (top_rapiditydiff_Marco_gen_branch != 0) {
				top_rapiditydiff_Marco_gen_branch->GetEntry(index);
			} else {
				printf("branch top_rapiditydiff_Marco_gen_branch does not exist!\n");
				exit(1);
			}
			top_rapiditydiff_Marco_gen_isLoaded = true;
		}
		return top_rapiditydiff_Marco_gen_;
	}
	float &tt_pT_gen()
	{
		if (not tt_pT_gen_isLoaded) {
			if (tt_pT_gen_branch != 0) {
				tt_pT_gen_branch->GetEntry(index);
			} else {
				printf("branch tt_pT_gen_branch does not exist!\n");
				exit(1);
			}
			tt_pT_gen_isLoaded = true;
		}
		return tt_pT_gen_;
	}
	float &top_costheta_cms_gen()
	{
		if (not top_costheta_cms_gen_isLoaded) {
			if (top_costheta_cms_gen_branch != 0) {
				top_costheta_cms_gen_branch->GetEntry(index);
			} else {
				printf("branch top_costheta_cms_gen_branch does not exist!\n");
				exit(1);
			}
			top_costheta_cms_gen_isLoaded = true;
		}
		return top_costheta_cms_gen_;
	}
	float &lep_charge_asymmetry_gen()
	{
		if (not lep_charge_asymmetry_gen_isLoaded) {
			if (lep_charge_asymmetry_gen_branch != 0) {
				lep_charge_asymmetry_gen_branch->GetEntry(index);
			} else {
				printf("branch lep_charge_asymmetry_gen_branch does not exist!\n");
				exit(1);
			}
			lep_charge_asymmetry_gen_isLoaded = true;
		}
		return lep_charge_asymmetry_gen_;
	}
	float &lep_azimuthal_asymmetry_gen()
	{
		if (not lep_azimuthal_asymmetry_gen_isLoaded) {
			if (lep_azimuthal_asymmetry_gen_branch != 0) {
				lep_azimuthal_asymmetry_gen_branch->GetEntry(index);
			} else {
				printf("branch lep_azimuthal_asymmetry_gen_branch does not exist!\n");
				exit(1);
			}
			lep_azimuthal_asymmetry_gen_isLoaded = true;
		}
		return lep_azimuthal_asymmetry_gen_;
	}
	float &lep_azimuthal_asymmetry2_gen()
	{
		if (not lep_azimuthal_asymmetry2_gen_isLoaded) {
			if (lep_azimuthal_asymmetry2_gen_branch != 0) {
				lep_azimuthal_asymmetry2_gen_branch->GetEntry(index);
			} else {
				printf("branch lep_azimuthal_asymmetry2_gen_branch does not exist!\n");
				exit(1);
			}
			lep_azimuthal_asymmetry2_gen_isLoaded = true;
		}
		return lep_azimuthal_asymmetry2_gen_;
	}
	float &lepPlus_costheta_cms_gen()
	{
		if (not lepPlus_costheta_cms_gen_isLoaded) {
			if (lepPlus_costheta_cms_gen_branch != 0) {
				lepPlus_costheta_cms_gen_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_costheta_cms_gen_branch does not exist!\n");
				exit(1);
			}
			lepPlus_costheta_cms_gen_isLoaded = true;
		}
		return lepPlus_costheta_cms_gen_;
	}
	float &lepMinus_costheta_cms_gen()
	{
		if (not lepMinus_costheta_cms_gen_isLoaded) {
			if (lepMinus_costheta_cms_gen_branch != 0) {
				lepMinus_costheta_cms_gen_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_costheta_cms_gen_branch does not exist!\n");
				exit(1);
			}
			lepMinus_costheta_cms_gen_isLoaded = true;
		}
		return lepMinus_costheta_cms_gen_;
	}
	float &top_spin_correlation_gen()
	{
		if (not top_spin_correlation_gen_isLoaded) {
			if (top_spin_correlation_gen_branch != 0) {
				top_spin_correlation_gen_branch->GetEntry(index);
			} else {
				printf("branch top_spin_correlation_gen_branch does not exist!\n");
				exit(1);
			}
			top_spin_correlation_gen_isLoaded = true;
		}
		return top_spin_correlation_gen_;
	}
	float &lep_cos_opening_angle_gen()
	{
		if (not lep_cos_opening_angle_gen_isLoaded) {
			if (lep_cos_opening_angle_gen_branch != 0) {
				lep_cos_opening_angle_gen_branch->GetEntry(index);
			} else {
				printf("branch lep_cos_opening_angle_gen_branch does not exist!\n");
				exit(1);
			}
			lep_cos_opening_angle_gen_isLoaded = true;
		}
	...
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &b()
	{
		if (not b_isLoaded) {
			if (b_branch != 0) {
				b_branch->GetEntry(index);
			} else {
				printf("branch b_branch does not exist!\n");
				exit(1);
			}
			b_isLoaded = true;
		}
	...
	{
		if (not bbar_isLoaded) {
			if (bbar_branch != 0) {
				bbar_branch->GetEntry(index);
			} else {
				printf("branch bbar_branch does not exist!\n");
				exit(1);
			}
			bbar_isLoaded = true;
		}
	...
	{
		if (not lepPlus_status3_isLoaded) {
			if (lepPlus_status3_branch != 0) {
				lepPlus_status3_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_status3_branch does not exist!\n");
				exit(1);
			}
			lepPlus_status3_isLoaded = true;
		}
		return *lepPlus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepMinus_status3()
	{
		if (not lepMinus_status3_isLoaded) {
			if (lepMinus_status3_branch != 0) {
				lepMinus_status3_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_status3_branch does not exist!\n");
				exit(1);
			}
			lepMinus_status3_isLoaded = true;
		}
		return *lepMinus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bPlus_status3()
	{
		if (not bPlus_status3_isLoaded) {
			if (bPlus_status3_branch != 0) {
				bPlus_status3_branch->GetEntry(index);
			} else {
				printf("branch bPlus_status3_branch does not exist!\n");
				exit(1);
			}
			bPlus_status3_isLoaded = true;
		}
		return *bPlus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bMinus_status3()
	{
		if (not bMinus_status3_isLoaded) {
			if (bMinus_status3_branch != 0) {
				bMinus_status3_branch->GetEntry(index);
			} else {
				printf("branch bMinus_status3_branch does not exist!\n");
				exit(1);
			}
			bMinus_status3_isLoaded = true;
		}
		return *bMinus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuPlus_status3()
	{
		if (not nuPlus_status3_isLoaded) {
			if (nuPlus_status3_branch != 0) {
				nuPlus_status3_branch->GetEntry(index);
			} else {
				printf("branch nuPlus_status3_branch does not exist!\n");
				exit(1);
			}
			nuPlus_status3_isLoaded = true;
		}
		return *nuPlus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status3()
	{
		if (not nuMinus_status3_isLoaded) {
			if (nuMinus_status3_branch != 0) {
				nuMinus_status3_branch->GetEntry(index);
			} else {
				printf("branch nuMinus_status3_branch does not exist!\n");
				exit(1);
			}
			nuMinus_status3_isLoaded = true;
		}
		return *nuMinus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topPlus_status3()
	{
		if (not topPlus_status3_isLoaded) {
			if (topPlus_status3_branch != 0) {
				topPlus_status3_branch->GetEntry(index);
			} else {
				printf("branch topPlus_status3_branch does not exist!\n");
				exit(1);
			}
			topPlus_status3_isLoaded = true;
		}
		return *topPlus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topMinus_status3()
	{
		if (not topMinus_status3_isLoaded) {
			if (topMinus_status3_branch != 0) {
				topMinus_status3_branch->GetEntry(index);
			} else {
				printf("branch topMinus_status3_branch does not exist!\n");
				exit(1);
			}
			topMinus_status3_isLoaded = true;
		}
		return *topMinus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WPlus_status3()
	{
		if (not WPlus_status3_isLoaded) {
			if (WPlus_status3_branch != 0) {
				WPlus_status3_branch->GetEntry(index);
			} else {
				printf("branch WPlus_status3_branch does not exist!\n");
				exit(1);
			}
			WPlus_status3_isLoaded = true;
		}
		return *WPlus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WMinus_status3()
	{
		if (not WMinus_status3_isLoaded) {
			if (WMinus_status3_branch != 0) {
				WMinus_status3_branch->GetEntry(index);
			} else {
				printf("branch WMinus_status3_branch does not exist!\n");
				exit(1);
			}
			WMinus_status3_isLoaded = true;
		}
		return *WMinus_status3_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepPlus_status1()
	{
		if (not lepPlus_status1_isLoaded) {
			if (lepPlus_status1_branch != 0) {
				lepPlus_status1_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_status1_branch does not exist!\n");
				exit(1);
			}
			lepPlus_status1_isLoaded = true;
		}
		return *lepPlus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepMinus_status1()
	{
		if (not lepMinus_status1_isLoaded) {
			if (lepMinus_status1_branch != 0) {
				lepMinus_status1_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_status1_branch does not exist!\n");
				exit(1);
			}
			lepMinus_status1_isLoaded = true;
		}
		return *lepMinus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bPlus_status1()
	{
		if (not bPlus_status1_isLoaded) {
			if (bPlus_status1_branch != 0) {
				bPlus_status1_branch->GetEntry(index);
			} else {
				printf("branch bPlus_status1_branch does not exist!\n");
				exit(1);
			}
			bPlus_status1_isLoaded = true;
		}
		return *bPlus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &bMinus_status1()
	{
		if (not bMinus_status1_isLoaded) {
			if (bMinus_status1_branch != 0) {
				bMinus_status1_branch->GetEntry(index);
			} else {
				printf("branch bMinus_status1_branch does not exist!\n");
				exit(1);
			}
			bMinus_status1_isLoaded = true;
		}
		return *bMinus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuPlus_status1()
	{
		if (not nuPlus_status1_isLoaded) {
			if (nuPlus_status1_branch != 0) {
				nuPlus_status1_branch->GetEntry(index);
			} else {
				printf("branch nuPlus_status1_branch does not exist!\n");
				exit(1);
			}
			nuPlus_status1_isLoaded = true;
		}
		return *nuPlus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status1()
	{
		if (not nuMinus_status1_isLoaded) {
			if (nuMinus_status1_branch != 0) {
				nuMinus_status1_branch->GetEntry(index);
			} else {
				printf("branch nuMinus_status1_branch does not exist!\n");
				exit(1);
			}
			nuMinus_status1_isLoaded = true;
		}
		return *nuMinus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topPlus_status1()
	{
		if (not topPlus_status1_isLoaded) {
			if (topPlus_status1_branch != 0) {
				topPlus_status1_branch->GetEntry(index);
			} else {
				printf("branch topPlus_status1_branch does not exist!\n");
				exit(1);
			}
			topPlus_status1_isLoaded = true;
		}
		return *topPlus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &topMinus_status1()
	{
		if (not topMinus_status1_isLoaded) {
			if (topMinus_status1_branch != 0) {
				topMinus_status1_branch->GetEntry(index);
			} else {
				printf("branch topMinus_status1_branch does not exist!\n");
				exit(1);
			}
			topMinus_status1_isLoaded = true;
		}
		return *topMinus_status1_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WPlus_status3_orig()
	{
		if (not WPlus_status3_orig_isLoaded) {
			if (WPlus_status3_orig_branch != 0) {
				WPlus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch WPlus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			WPlus_status3_orig_isLoaded = true;
		}
		return *WPlus_status3_orig_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &WMinus_status3_orig()
	{
		if (not WMinus_status3_orig_isLoaded) {
			if (WMinus_status3_orig_branch != 0) {
				WMinus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch WMinus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			WMinus_status3_orig_isLoaded = true;
		}
	...
	{
		if (not lepPlus_status3_orig_isLoaded) {
			if (lepPlus_status3_orig_branch != 0) {
				lepPlus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch lepPlus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			lepPlus_status3_orig_isLoaded = true;
		}
		return *lepPlus_status3_orig_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lepMinus_status3_orig()
	{
		if (not lepMinus_status3_orig_isLoaded) {
			if (lepMinus_status3_orig_branch != 0) {
				lepMinus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch lepMinus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			lepMinus_status3_orig_isLoaded = true;
		}
		return *lepMinus_status3_orig_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuPlus_status3_orig()
	{
		if (not nuPlus_status3_orig_isLoaded) {
			if (nuPlus_status3_orig_branch != 0) {
				nuPlus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch nuPlus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			nuPlus_status3_orig_isLoaded = true;
		}
		return *nuPlus_status3_orig_;
	}
	ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &nuMinus_status3_orig()
	{
		if (not nuMinus_status3_orig_isLoaded) {
			if (nuMinus_status3_orig_branch != 0) {
				nuMinus_status3_orig_branch->GetEntry(index);
			} else {
				printf("branch nuMinus_status3_orig_branch does not exist!\n");
				exit(1);
			}
			nuMinus_status3_orig_isLoaded = true;
		}
		return *nuMinus_status3_orig_;
	}
