...
declare -a ttbarSamples=(DY1to4Jtot DY1to4Jeemm DY1to4Jtautau ttdl_mcatnlo ttsl_mcatnlo ttfake_mcatnlo tttt_mcatnlo ttdl_powheg_SCbug ttsl_powheg_SCbug ttfake_powheg_SCbug ttdl_powheg_SCfix ttsl_powheg_SCfix ttfake_powheg_SCfix)
